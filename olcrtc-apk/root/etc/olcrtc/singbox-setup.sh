...
CONFIG="olcrtc"
SINGBOX_DIR="/var/etc/olrtc/sing-box"
...
build_json() {
	...
	# Auto-bypass olcrtc/wdtt server endpoints to avoid routing loops
...
EOF
  ...
  "route": {
    ...
    "rules": [
      ...
      { "process_name": ["olcrtc", "wdtt-server", "sing-box"], "action": "route", "outbound": "direct" },
