...
download_olcrtcwrt() {
	local tag="latest"
	local url="https://github.com/$OLCRTC_REPO/releases/$tag/download/olcrtc-linux-"
	local dest="$BIN_DIR/olcrtcwrt"
	echo "Downloading olcrtcwrt ($GOARCH)..."
